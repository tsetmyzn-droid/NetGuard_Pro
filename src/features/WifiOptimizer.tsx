  ...
  return (
    <div className="p-4 md:p-8 space-y-6 pb-24 md:pb-8">
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">Wi-Fi Optimizer</h2>
          <p className="text-slate-500">Analyze and reduce network congestion</p>
        </div>
        <button 
          ...
          <DashboardCard title="Optimization Result">
            {bestChannel ? (
              <div className="text-center py-6">
                <div className="w-20 h-20 bg-green-50 text-green-600 rounded-[24px] flex items-center justify-center mx-auto mb-4 border border-green-100">
                  <Zap className="w-10 h-10" />
                </div>
                <h4 className="text-xl font-bold text-slate-900">Channel {bestChannel}</h4>
                <p className="text-sm text-slate-500 mt-2">This is the cleanest channel for your router.</p>
          ...
          <DashboardCard title="Spectrum Tips">
            <div className="space-y-4 mt-4">
              <div className="flex gap-3">
                <div className="w-8 h-8 bg-blue-50 text-blue-600 rounded-lg flex-shrink-0 flex items-center justify-center">
              ...
              <div className="flex gap-3">
                <div className="w-8 h-8 bg-orange-50 text-orange-600 rounded-lg flex-shrink-0 flex items-center justify-center">
